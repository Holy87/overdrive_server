...
) ENGINE=MyISAM  DEFAULT CHARSET=latin1 COMMENT='Tabella giocatori' AUTO_INCREMENT=12 ;
...
insert into settings (setting_key, value) VALUES ('migration_order', '1');
insert into settings (setting_key, value) VALUES ('admin_mails', '');