...
class BoardService
{
    ...
    public static function post_board_message(string $game_id, string $sphere_id, string $message) {
        ...
        if (BoardRepository::create_message($game_id, $sphere_id, $message, $reply_to)) {
            if($reply_to != null) {
                ...
                if ($replied) {
                    ...
                    NotificationRepository::add_notification($replied->get_game_id(), Notification::BOARD_REPLY_TYPE, $info);
                }
            }
            return ok_response();
        }
